---
title: The domestic record — what Israel has already tried on transit enforcement, fares and congestion
...
`[UNVERIFIED — verify before publication]` Plenum passage and commencement of the January 2026 fine-reduction bill; the current status of the Congestion Charge Law; the identity of the February 2025 position-paper submitter ([PDF](https://fs.knesset.gov.il/25/Committees/25_cs_bg_5720839.pdf), not machine-readable — must be read manually).
