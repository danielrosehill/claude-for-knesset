---
title: Israeli law and regulation — public transport enforcement, fares, congestion and noise
...
- No duty on inspectors to identify themselves in a verifiable way, and no bodycam framework (which would in any case require a privacy-law analysis; see the Swedish and CJEU precedents in `comparative/united-kingdom-orr.md`).

## 2. Fares and concessions

- **Derekh Shava (דרך שווה)**, in force **1 August 2022**: national distance-banded tariff across bus, light rail and heavy rail; bands at 15 / 40 / 75 / 120 / 225 km and unlimited; cash phased out on buses. Local journey ≤ 15 km: **NIS 8**. National unlimited monthly pass: **NIS 225**.
...
The **Congestion Charge Law (חוק גודש)** legislates a cordon charge for the Tel Aviv metropolitan area. Its status is the most volatile fact in this document:
...
`[UNVERIFIED — verify before publication]` Current commencement status as of July 2026, and whether the cancellation decision was adopted. Sources: [Globes](https://en.globes.co.il/en/article-regev-seeks-to-scupper-tel-aviv-congestion-charge-1001484793), [Jerusalem Post](https://www.jpost.com/business-and-innovation/energy-and-infrastructure/article-842896).

Two implications:

1. **Jerusalem is not covered.** Any congestion-pricing proposal for Jerusalem is a new instrument, not an extension — and would be indefensible before the Blue Line opens.
2. **A cabinet minister actively working to kill an enacted law before its commencement date is the cleanest available illustration of this platform's political-accountability thesis.** Cross-reference `policy/political-accountability/`.

## 4. Noise and honking

- **Abatement of Nuisances Law, 5721-1961 (חוק למניעת מפגעים, התשכ"א-1961)** — prohibits causing loud or unreasonable noise that disturbs, or is liable to disturb, people nearby. Breach is a **criminal offence**; **police** are the primary enforcement authority and may impose fines.
...
- **Jerusalem Municipal Bylaw (Prevention of Noise), 5767-2007 (חוק עזר לירושלים (מניעת רעש), התשס"ז-2007)** — [text](https://www.jerusalem.muni.il/media/5127/noise2007.pdf).
...
- **State Comptroller special report, *The Public Transport Crisis* (משבר התחבורה הציבורית)** — [summary](https://transportation.org.il/paper/דוח-מבקר-המדינה-משבר-התחבורה-הציבורית/). Must be read in full and cited by chapter before stage 3.
...
- **State Comptroller, 2024**: accessibility of public transport for people with disabilities — [report PDF](https://library.mevaker.gov.il/sites/DigitalLibrary/Documents/2024/2024.11-75A-PartB/2024.11-75A-PartB-204-Hangasha.pdf). Overlaps substantially with validation-accessibility.
- **Public Complaints Commissioner, 2023**: complaints against the Ministry of Transport up **28%** year on year, concentrated in the National Public Transport Authority and Licensing ([Kan](https://www.kan.org.il/content/kan-news/politic/765150/)).

## What a minister could do tomorrow, without the Knesset

The most useful output of this document:

1. Issue a directive capping repeat inspections of the same passenger on the same journey.
2. Instruct that a validated safe harbour applies where a passenger holds a loaded valid fare and the device failed — administratively, by amending the cancellation procedure (נוהל) already introduced in 2024.
3. Write conduct, de-escalation and language-access requirements into operator **licence conditions** at the next tender cycle, with financial consequences.
4. Require operators to publish monthly inspection, fine, cancellation and complaint statistics — the data that does not currently exist.
5. Stand up an appeal route independent of the operator.
6. Mandate English and Arabic parity on every validator interface and every fine notice.
