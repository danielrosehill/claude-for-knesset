---
title: "Policy area: Open government data & transparency"
description: Transparency, publication duties, and the data the government chooses not to release.
sidebar:
  label: Open government data
  order: 5
---
...
- **CBS** (הלמ"ס) as a parallel and generally stronger channel: what it publishes, at what geographic granularity, and where its API and this platform's own [israel-statistics MCP server](../../method/plugin.md) already provide better access than the open-data portal does. The contrast is itself a finding.
