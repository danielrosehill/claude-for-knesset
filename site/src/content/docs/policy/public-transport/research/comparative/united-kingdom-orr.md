---
title: United Kingdom — regulating the revenue inspector
jurisdiction: United Kingdom (Great Britain rail)
instrument: Independent regulator-led review of train operators' revenue protection practices, plus passenger-rights bodies and an ombudsman
adopted: review commissioned 2024, reported 2025
status: recommendations issued; implementation ongoing
last-verified: 2026-07-23
role: the near-match on mechanism — the only comparator that treats *enforcement conduct itself* as the policy problem
---
...
`[UNVERIFIED — verify before publication]` The review's specific recommendations, its publication date, and which have been accepted. The ORR site returned HTTP 403 to automated fetching; the chapters are at [orr.gov.uk/independent-review-train-operators-revenue-protection-practices](https://www.orr.gov.uk/independent-review-train-operators-revenue-protection-practices/4-revenue-protection-policies-and) and must be read manually before citation. **This case study is currently built on search-result excerpts, not the primary document, and is the weakest-sourced item in the comparative file.**
...
- ORR, *Independent review of train operators' revenue protection practices* — [ch. 4](https://www.orr.gov.uk/independent-review-train-operators-revenue-protection-practices/4-revenue-protection-policies-and), [ch. 5 Prosecutions](https://www.orr.gov.uk/independent-review-train-operators-revenue-protection-practices/5-prosecutions) *(not yet read in full — see verification debt)*
- [TTC constables and fare inspectors to wear bodycams](https://www.torontotoday.ca/local/transportation-infrastructure/ttc-constables-fare-inspectors-wear-bodycams-pilot-project-9874325) (journalism, flagged)
- [EDPB — unlawful use of body cams in Stockholm's public transport](https://edpb.europa.eu/news/national-news/2021/unlawful-use-body-cams-stockholms-public-transport_lv)
- [CJEU on personal data collected by ticket inspectors' body cameras](http://www.legalpost.eu/2025/12/personal-data-collected-by-means-of.html)
- [Revenue protection inspector — Wikipedia](https://en.wikipedia.org/wiki/Revenue_protection_inspector)
