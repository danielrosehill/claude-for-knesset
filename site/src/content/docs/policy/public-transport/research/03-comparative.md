...
sidebar:
  label: 3 · Comparative review
  order: 3
---

Method per the `comparative-policy-research` skill. Case studies: [Germany](./comparative/germany-deutschlandticket.md), [Vienna](./comparative/vienna.md), [Tallinn & Luxembourg](./comparative/tallinn-luxembourg.md), [the UK ORR](./comparative/united-kingdom-orr.md).
...
1. **Fare-free transit** (Tallinn, Luxembourg, Montpellier) — the policy closest to the testimony's own instinct, and the one the evidence least supports. Detailed in [`comparative/tallinn-luxembourg.md`](./comparative/tallinn-luxembourg.md).
...
## Comparators considered and rejected
